                    ...
                    <div className="row">
                        ...
                        <div className="card direct-chat direct-chat-primary">
                            ...
                            <div className="direct-chat-messages">
                                ...
                                {/* /.direct-chat-infos */}
                                <img className="direct-chat-img" src="../admin-lte/dist/img/user1-128x128.jpg" alt="message user image" />
                                {/* /.direct-chat-img */}
                                ...
                                {/* /.direct-chat-infos */}
                                <img className="direct-chat-img" src="../admin-lte/dist/img/user3-128x128.jpg" alt="message user image" />
                                {/* /.direct-chat-img */}
                                <div className="direct-chat-text">
                            ...
                            <div className="direct-chat-contacts">
                                ...
                                <li>
                                    <a href="#">
                                    <img className="contacts-list-img" src="../admin-lte/dist/img/user1-128x128.jpg" alt="User Avatar" />
                                ...
                                <li>
                                    <a href="#">
                                    <img className="contacts-list-img" src="../admin-lte/dist/img/user7-128x128.jpg" alt="User Avatar" />
                                    <div className="contacts-list-info">
                                        <span className="contacts-list-name">
                                        Sarah Doe
                                ...
                                <li>
                                    <a href="#">
                                    <img className="contacts-list-img" src="../admin-lte/dist/img/user3-128x128.jpg" alt="User Avatar" />
                                    <div className="contacts-list-info">
                                        <span className="contacts-list-name">
                                        Nadia Jolie
                                ...
                                <li>
                                    <a href="#">
                                    <img className="contacts-list-img" src="../admin-lte/dist/img/user5-128x128.jpg" alt="User Avatar" />
                                    <div className="contacts-list-info">
                                        <span className="contacts-list-name">
                                        Nora S. Vans
                                ...
                                <li>
                                    <a href="#">
                                    <img className="contacts-list-img" src="../admin-lte/dist/img/user6-128x128.jpg" alt="User Avatar" />
                                    <div className="contacts-list-info">
                                        <span className="contacts-list-name">
                                        John K.
                                ...
                                <li>
                                    <a href="#">
                                    <img className="contacts-list-img" src="../admin-lte/dist/img/user8-128x128.jpg" alt="User Avatar" />
                                    <div className="contacts-list-info">
                                        <span className="contacts-list-name">
                                        Kenneth M.
